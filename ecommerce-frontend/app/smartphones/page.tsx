...
export default function SmartphonesPageUI({
  products = [],
  query,
  loading = false,
}: {
  ...
  return (
    <Layout>
      <div className="mx-auto max-w-screen-2xl px-4 py-12 sm:px-6 lg:px-8">
        <h2 className="mb-2 text-2xl font-bold sm:text-3xl">Smartphones</h2>
        {query && (
        ...
        {loading ? (
          ...
          <div className="py-12 text-center">
            <p className="text-gray-500 dark:text-zinc-400">No smartphones found.</p>
          </div>
        )}
      </div>
    </Layout>
